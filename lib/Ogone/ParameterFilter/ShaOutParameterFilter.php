...
class ShaOutParameterFilter implements ParameterFilter
{
    private $allowed = array(
        ...
        'ALIAS', 'AMOUNT', 'BIC', 'BIN', 'BRAND', 'CARDNO', 'CCCTY', 'CH_AUTHENTICATION_INFO', 'CN', 'COLLECTOR_BIC',
        'COLLECTOR_IBAN', 'COMPLETIONID', 'COMPLUS', 'CREATION_STATUS', 'CREDITDEBIT', 'CURRENCY', 'CVCCHECK',
        ...
        'NBRUSAGE', 'NCERROR', 'ORDERID', 'PAYID', 'PAYIDSUB', 'PAYMENT_REFERENCE', 'PM', 'REQUESTCOMPLETIONID',
